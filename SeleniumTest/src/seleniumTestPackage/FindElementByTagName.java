...
public class FindElementByTagName extends MoreSeleniumTestClass	 {
	...
	/** So this doesn't work. The issue has to do with TagName. I don't fiully understand selenium websearch by tags!!!!
	...
	public void findByTagName()	{
		...
		WebElement searchBox = tracy.findElements(By.tagName("input")).get(0); //??????????????????
		Sleep(5);
